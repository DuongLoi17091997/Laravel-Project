							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="bestseller">
									...
									<div id="bestsell-carousel" class="owl-carousel custom-carousel">
										...
										@foreach ($productList as $iphone)
											@if ($iphone->category_name == 'Iphone')
												
										
												<form>
													@csrf
													<input type="hidden" value="{{$iphone->id}}" class="cart_product_id_{{ $iphone->id}}">
													<input type="hidden" value="{{$iphone->product_code}}" class="cart_product_code_{{ $iphone->id}}">
													<input type="hidden" value="{{$iphone->name}}" class="cart_product_name_{{ $iphone->id}}">
													<input type="hidden" value="{{$iphone->img_path}}" class="cart_product_img_{{ $iphone->id}}">
													<input type="hidden" value="{{$iphone->price}}" class="cart_product_price_{{ $iphone->id}}">
													<input type="hidden" value="{{$iphone->quantity}}" class="cart_product_storage_{{ $iphone->id}}">
													<input type="hidden" value="1" class="cart_product_quantity_{{ $iphone->id}}">
														<div class="singel-product single-product-col">
															<div class="label-pro-sale">hot</div>
															<!-- Single Product Image -->
															<div class="single-product-img">
																<a href="{{ route('products-details', ['id'=>$iphone->id]) }}"><img src="images/{{ $iphone->img_path}}" alt="{{ $iphone->name}}"></a>
															</div>
															<!-- Single Product Content -->
															<div class="single-product-content">
																<h2 class="product-name"><a title="{{ $iphone->name}}" href="{{ route('products-details', ['id'=>$iphone->id]) }}"> {{ $iphone->name}}</a></h2>
																<div class="product-price">
																	<p>${{number_format($iphone->price,2)}}</p>
																</div>
																<!-- Single Product Actions -->
																<div class="product-actions">
																	<button class="button btn-cart add-to-cart" data-id="{{ $iphone->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
							...
							<div class="single-product-category">
								...
								<div class="product-view">
									...
									<div id="laptop-carousel" class="owl-carousel custom-carousel">
										...
										@foreach ($productList as $mac)
											@if ($mac->category_name == 'Mac')
												...
												<div class="singel-product single-product-col">
													...
													<!-- Single Product Image -->
													<div class="single-product-img">
														<a href="{{ route('products-details', ['id'=>$mac->id]) }}"><img src="images/{{$mac->img_path}}" alt="{{$mac->name}}"></a>
													</div>
													<!-- Single Product Content -->
													<form>
														@csrf
															<input type="hidden" value="{{$mac->id}}" class="cart_product_id_{{ $mac->id}}">
															<input type="hidden" value="{{$mac->product_code}}" class="cart_product_code_{{ $mac->id}}">
															<input type="hidden" value="{{$mac->name}}" class="cart_product_name_{{ $mac->id}}">
															<input type="hidden" value="{{$mac->img_path}}" class="cart_product_img_{{ $mac->id}}">
															<input type="hidden" value="{{$mac->price}}" class="cart_product_price_{{ $mac->id}}">
															<input type="hidden" value="{{$mac->quantity}}" class="cart_product_storage_{{ $mac->id}}">
															<input type="hidden" value="1" class="cart_product_quantity_{{ $mac->id}}">
														<div class="single-product-content">
															<h2 class="product-name"><a title="{{$mac->name}}" href="{{ route('products-details', ['id'=>$mac->id]) }}"> {{$mac->name}}</a></h2>
															<div class="product-price">
																<p>
																	{{-- <span>$2099</span> --}}
																	${{number_format($mac->price,2)}}
																</p>
															</div>
															<!-- Single Product Actions -->
															<div class="product-actions">
																<button class="button btn-cart add-to-cart" data-id="{{ $mac->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
																{{-- <div class="add-to-link">
																	<ul class="">
																		<li class="quic-view"><button type="button" data-bs-target="#productModal" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
																		<li class="wishlist"><a href="#"><i class="fa fa-heart"></i></a></li>
													...
													</form><!-- End Single Product Content -->
												</div><!-- End Single Product -->
											@endif
										@endforeach
							...
							<div class="single-product-category">
								...
								<div class="product-view">
									...
									<div id="tablet-carousel" class="owl-carousel custom-carousel">
										<!-- Single Product -->
										@foreach ($productList as $ipad)
											@if ($ipad->category_name == 'Ipad')
												<div class="singel-product single-product-col">
													<div class="label-pro-sale">hot</div>
													<!-- Single Product Image -->
													<div class="single-product-img">
														<a href="{{ route('products-details', ['id'=>$ipad->id]) }}"><img src="images/{{$ipad->img_path}}" alt="{{$ipad->name}}"></a>
													</div>
													<!-- Single Product Content -->
													<form>
														@csrf
															<input type="hidden" value="{{$ipad->id}}" class="cart_product_id_{{ $ipad->id}}">
															<input type="hidden" value="{{$ipad->product_code}}" class="cart_product_code_{{ $ipad->id}}">
															<input type="hidden" value="{{$ipad->name}}" class="cart_product_name_{{ $ipad->id}}">
															<input type="hidden" value="{{$ipad->img_path}}" class="cart_product_img_{{ $ipad->id}}">
															<input type="hidden" value="{{$ipad->price}}" class="cart_product_price_{{ $ipad->id}}">
															<input type="hidden" value="{{$ipad->quantity}}" class="cart_product_storage_{{ $ipad->id}}">
															<input type="hidden" value="1" class="cart_product_quantity_{{ $ipad->id}}">
														<div class="single-product-content">
															<h2 class="product-name"><a title="{{$ipad->name}}" href="{{ route('products-details', ['id'=>$ipad->id]) }}"> {{$ipad->name}}</a></h2>
															<div class="product-price">
																<p>
																	<span>$2099</span>
																	${{number_format($ipad->price,2)}}
																</p>
															</div>
															<!-- Single Product Actions -->
															<div class="product-actions">
																<button class="button btn-cart add-to-cart" data-id="{{ $ipad->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
																{{-- <div class="add-to-link">
																	<ul class="">
																		<li class="quic-view"><button type="button" data-bs-target="#productModal" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
																		<li class="wishlist"><a href="#"><i class="fa fa-heart"></i></a></li>
								...
								@foreach ($blogList as $blog)
									...
									<div class="single-blog-post">
										<div class="blog-post-img">
											<a href="{{ route('blog-details', ['id'=>$blog ->id]) }}"><img src="{{ asset('images/blogThumbnail/'.$blog ->thumbnail) }}" alt="blog"></a>
										</div>
										...
										<div class="single-blog-post-content">
											...
											<div class="date-time">
												...
												<div class="time-comment">
													<span><i class="fa fa-comments-o"></i>999View </span>
												</div>
											</div>
											<a href="{{ route('blog-details', ['id'=>$blog ->id]) }}" class="readmore">Read more</a>
