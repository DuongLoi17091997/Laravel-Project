            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav me-auto">
                        <a class="navbar-brand" href="{{ route('admin.category.categories') }}"><img src="{{ asset('images/logoApple2.png') }}" alt="logo" class="light-logo2"></a>
                ...
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            ...
                            <a class="has-arrow waves-effect waves-dark active" href="{{ route('admin.category.categories') }}" aria-expanded="false"></i><span class="hide-menu">Categories</span></a>
                        </li>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <a href="{{ route('admin.category.addCategory') }}" class="btn btn-sm btn-primary pull-left mb-3"><i class="fa fa-plus-circle"></i> Add New</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 10%">
                                                        <div class="button-group">
                                                            <button type="button" class="btn btn-warning edit" onclick="window.location.href = '{{ route('admin.category.editCategory', ['id'=>$categories->category_id]) }}'">
                                                            ...
                                                            <button type="button" class="btn btn-primary delete" id="{{ $categories->category_id }}">
